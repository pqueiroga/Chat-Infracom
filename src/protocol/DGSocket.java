...
//	private int[] acksDuplicados = new int[RcvBuffer];
	...
	public DGSocket(long[] estimatedrtt, double pDescartaPacotes, int[] pktsPerdidos, String remoteIP, int remotePort, String ESTADO, int ackNum,
			boolean settimeout) throws IOException {
...
//	}
	...
	public DGSocket(int[] pktsPerdidos, int port, String remoteIP, int remotePort, String ESTADO, int ackNum,
			boolean settimeout) throws IOException {
		this(null, 0, pktsPerdidos, port, remoteIP, remotePort, ESTADO, ackNum, settimeout);
	}
	
	public DGSocket(long[] estimatedrtt, double pDescartaPacotes, int[] pktsPerdidos, int port, String remoteIP, int remotePort, String ESTADO, int ackNum
			, boolean settimeout) throws IOException {
